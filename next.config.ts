        ...
        headers: [
          ...
          { key: 'Cross-Origin-Embedder-Policy', value: 'unsafe-none' },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co https://www.google-analytics.com https://vitals.vercel-insights.com https://api.openai.com https://generativelanguage.googleapis.com",
              "frame-src 'none'",
              "object-src 'none'",
              "base-uri 'self'",
