        ...
        <div className="bg-white">
            ...
            <section className="max-w-4xl mx-auto px-6 py-16">
                <div className="prose prose-lg max-w-none">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Reservas y Pagos</h2>
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Política de Cancelación</h2>
                    <p className="text-gray-600 mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Responsabilidad del Huésped</h2>
                    <p className="text-gray-600 mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Privacidad y Datos Personales</h2>
                    <p className="text-gray-600 mb-6">
