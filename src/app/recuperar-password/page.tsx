      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          {!sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all text-sm bg-white text-gray-900 placeholder-gray-400"
            ...
            <div className="text-center py-8">
              ...
              <Link
                href="/login"
                className="inline-block mt-6 text-sm text-red-600 hover:text-red-700 font-medium hover:underline"
              >
                Volver al login
              </Link>
            </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            ¿Necesitas ayuda? <a href="/contacto" className="text-red-600 hover:text-red-700 font-medium hover:underline">Contáctanos</a>
          </p>
        </div>
      </div>
    </div>
