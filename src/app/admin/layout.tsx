                    ...
                    <div className="hidden md:block flex-1 max-w-xl mx-4">
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-2 pl-10 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
